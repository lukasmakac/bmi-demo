...
| AZURE_DNS_LABEL | The dns name label for container group with public IP. | `bmi-demo` |


### Verification
Call the rest api endpoint `[AZURE_DNS_LABEL].[AZURE_LOCATION].azurecontainer.io:[PORT]/bmiDemo`:
```
curl http://bmi-demo.westeurope.westeurope.azurecontainer.io:8080/bmiDemo
```
